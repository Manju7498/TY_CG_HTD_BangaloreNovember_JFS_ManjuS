...
public class CustomerController {
	...
	public ForestryResponse deleteCustomer(@PathVariable("customerId") int customerId) {
		ForestryResponse response = new ForestryResponse();
	...
	public ForestryResponse viewCustomer(@PathVariable("customerId") int customerId) {
		ForestryResponse response = new ForestryResponse();
	...
	public ForestryResponse updateCustomer(@RequestBody CustomerBean bean) {
		ForestryResponse response = new ForestryResponse();
