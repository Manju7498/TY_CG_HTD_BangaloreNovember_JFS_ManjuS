		...
		while (true) {
			...
			case 1:
				try {
					...
					while (!isValidPhoneNo) {
						System.err.println("Please enter valid phone number again(Ex:9876543210)");
			...
			case 4:
				try {
					...
					if (customer != null) {
						...
						for (CustomerBean customerBean1 : customer) {
							System.out.println("Customer id : " + customerBean1.getCustomerId());
							System.out.println("Customer name : " + customerBean1.getCustomerName());
							System.out.println("Customer address1 : " + customerBean1.getStreetAddress1());
							System.out.println("Customer address2 : " + customerBean1.getStreetAddress2());
							System.out.println("Customer town : " + customerBean1.getTown());
							...
							System.out.println("Customer email : " + customerBean1.getEmail());
							System.out.println(
									"Customer phonenumber : " + customerBean1.getCustomerPhoneNumber());
							System.out.println("*****************************************");
						}
					} else {
			...
			case 5:
				...
				try {
					...
					for (CustomerBean customerBean1 : customer2) {
						if (customerBean1.getCustomerId() == customerId1) {
							isupdate = true;
						}
					}
					if (isupdate) {
