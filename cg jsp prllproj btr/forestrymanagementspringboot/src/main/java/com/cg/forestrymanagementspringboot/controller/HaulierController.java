...
import com.cg.forestrymanagementspringboot.service.HaulierService;
...
public class HaulierController {
	...
	public ForestryResponse deleteHaulier(@PathVariable("haulierId") String haulierId) {
		ForestryResponse response = new ForestryResponse();
	...
	public ForestryResponse viewHaulier(@PathVariable("haulierId") String haulierId) {
		ForestryResponse response = new ForestryResponse();
	...
	@PutMapping(path = "/update-haulier/{haulierId}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public ForestryResponse updateHaulier(@PathVariable("haulierId") String haulierId,@RequestBody HaulierBean bean) {
		ForestryResponse response = new ForestryResponse();
		if (service.updateHaulier(haulierId,bean)) {
			response.setStatusCode(201);
			response.setMessage("success");
