package com.cg.empwebapp.controller;
...
import com.cg.empwebapp.service.EmployeeService;
...
public class EmployeeController {
	...
	public String register(EmployeeBean bean,ModelMap map) {
		...
		if(check) {
			map.addAttribute("msg","You have regsitered to Employee Portal");
		}else {
			map.addAttribute("msg","This email exists...!!!!");
		}
		return "login";
	}
	@GetMapping("/search")
	...
	public String changePassword(String password,@SessionAttribute("bean") EmployeeBean bean) {
		service.changePassword(bean.getEmployeeId(), password);
		return "home";	
	}
	@GetMapping("/logout")
